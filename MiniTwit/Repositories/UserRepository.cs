...
public class UserRepository : IUserRepository
{
    ...
    public async Task<User> Register(string username, string email, string password, string passwordRepeat)
    {
        ...
        if (!Regex.IsMatch(username, @"^[a-zA-Z0-9 _]+$") || username.ToLower() is "public" or "login" or "register" or "logout" or "twithub") throw new ArgumentException("Forbidden username.");
